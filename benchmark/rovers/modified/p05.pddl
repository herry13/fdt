...
(define (problem roverprob2435)
        ...
        (:constraints
         (and
              (sometime (calibrated camera2 rover0))
              ...
              (at-most-once (calibrated camera0 rover1))
              ;(sometime-before (at rover1 waypoint1) (have_rock_analysis rover0 waypoint0))
              ...
              (sometime-before (at rover1 waypoint2) (calibrated camera2 rover0))
              ...
              ;(sometime-before (at rover0 waypoint1) (calibrated camera1 rover1))
