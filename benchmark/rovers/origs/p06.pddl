...
(define (problem roverprob2312)
	...
	(sometime-before (at rover0 waypoint0) (have_image rover0 objective1 low_res))
	(sometime-before (at rover0 waypoint2) (full rover1store))
	(sometime-before (have_soil_analysis rover1 waypoint4) (full rover1store))
	...
	(sometime-before (have_rock_analysis rover0 waypoint0) (have_soil_analysis rover1 waypoint1))
