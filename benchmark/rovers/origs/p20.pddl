...
(define (problem roverprob7182)
	...
	(always (empty rover0store))
	(sometime (at rover7 waypoint21))
	(sometime (at rover7 waypoint5))
	(sometime (at rover7 waypoint4))
	(sometime (at rover7 waypoint15))
	(sometime (at rover7 waypoint14))
	(sometime (at rover7 waypoint9))
	(sometime (at rover6 waypoint20))
	(sometime (at rover6 waypoint23))
	(sometime (at rover6 waypoint1))
	(sometime (at rover6 waypoint16))
	(sometime (at rover6 waypoint18))
	(sometime (at rover6 waypoint8))
	(sometime (at rover6 waypoint7))
	(sometime (at rover6 waypoint13))
	(sometime (at rover6 waypoint11))
	(sometime (at rover5 waypoint23))
	(sometime (at rover5 waypoint18))
	(sometime (at rover5 waypoint15))
	(sometime (at rover4 waypoint5))
	...
	(sometime (have_soil_analysis rover6 waypoint8))
	(sometime (have_soil_analysis rover6 waypoint7))
	...
	(sometime (have_rock_analysis rover7 waypoint9))
	...
	(sometime (have_rock_analysis rover2 waypoint9))
	(sometime (calibrated camera3 rover2))
	(sometime (have_image rover6 objective7 colour))
	(sometime (have_image rover6 objective3 colour))
	...
	(sometime (have_image rover4 objective3 colour))
	...
	(at-most-once (at rover7 waypoint10))
	(at-most-once (at rover6 waypoint4))
	(at-most-once (at rover4 waypoint16))
	(at-most-once (at rover4 waypoint7))
	(at-most-once (at rover4 waypoint10))
	(at-most-once (at rover4 waypoint2))
	(at-most-once (at rover3 waypoint12))
	(at-most-once (at rover3 waypoint13))
	(at-most-once (at rover3 waypoint18))
	(at-most-once (at rover2 waypoint18))
	(at-most-once (at rover2 waypoint21))
	(at-most-once (at rover2 waypoint13))
	(at-most-once (at rover2 waypoint3))
	(at-most-once (at rover0 waypoint22))
	(at-most-once (at rover0 waypoint11))
	(at-most-once (at rover0 waypoint8))
	(at-most-once (empty rover6store))
	(at-most-once (full rover6store))
	(at-most-once (full rover0store))
	(at-most-once (empty rover7store))
	(at-most-once (full rover7store))
	(at-most-once (empty rover2store))
	(at-most-once (full rover2store))
	(at-most-once (calibrated camera6 rover6))
	...
	(sometime-before (at rover4 waypoint7) (have_soil_analysis rover3 waypoint23))
	(sometime-before (at rover4 waypoint7) (have_soil_analysis rover3 waypoint13))
	(sometime-before (at rover4 waypoint7) (full rover0store))
	(sometime-before (at rover4 waypoint7) (have_soil_analysis rover0 waypoint7))
	(sometime-before (at rover4 waypoint7) (have_rock_analysis rover7 waypoint10))
	(sometime-before (at rover4 waypoint7) (have_rock_analysis rover4 waypoint22))
	(sometime-before (at rover4 waypoint7) (have_rock_analysis rover3 waypoint21))
	(sometime-before (at rover4 waypoint7) (have_rock_analysis rover3 waypoint12))
	(sometime-before (at rover4 waypoint7) (have_rock_analysis rover2 waypoint22))
	(sometime-before (at rover4 waypoint7) (have_rock_analysis rover2 waypoint9))
	(sometime-before (at rover4 waypoint7) (have_image rover6 objective3 colour))
	(sometime-before (at rover4 waypoint7) (have_image rover6 objective0 high_res))
	(sometime-before (at rover4 waypoint7) (have_image rover5 objective5 high_res))
	(sometime-before (at rover4 waypoint7) (have_image rover4 objective7 colour))
	(sometime-before (at rover4 waypoint7) (have_image rover1 objective7 colour))
	(sometime-before (at rover4 waypoint7) (have_image rover1 objective3 colour))
	(sometime-before (at rover4 waypoint7) (have_image rover1 objective5 high_res))
	...
	(sometime-before (at rover3 waypoint12) (have_soil_analysis rover6 waypoint8))
	(sometime-before (at rover3 waypoint12) (have_soil_analysis rover3 waypoint23))
	(sometime-before (at rover3 waypoint12) (have_soil_analysis rover3 waypoint13))
	(sometime-before (at rover3 waypoint12) (have_soil_analysis rover0 waypoint8))
	(sometime-before (at rover3 waypoint12) (have_rock_analysis rover7 waypoint16))
	(sometime-before (at rover3 waypoint12) (have_rock_analysis rover7 waypoint14))
	(sometime-before (at rover3 waypoint12) (have_rock_analysis rover4 waypoint22))
	(sometime-before (at rover3 waypoint12) (have_rock_analysis rover4 waypoint14))
	(sometime-before (at rover3 waypoint12) (have_rock_analysis rover3 waypoint18))
	(sometime-before (at rover3 waypoint12) (have_image rover6 objective3 colour))
	...
	(sometime-before (at rover3 waypoint12) (have_image rover1 objective2 high_res))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover7 waypoint21))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover7 waypoint10))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover7 waypoint14))
	...
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover5 waypoint15))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover4 waypoint15))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover3 waypoint22))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover2 waypoint23))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover2 waypoint1))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover0 waypoint21))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover0 waypoint18))
	(sometime-before (have_rock_analysis rover4 waypoint7) (at rover0 waypoint14))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_soil_analysis rover6 waypoint23))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_soil_analysis rover6 waypoint20))
	(sometime-before (have_rock_analysis rover4 waypoint7) (full rover3store))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_soil_analysis rover3 waypoint20))
	(sometime-before (have_rock_analysis rover4 waypoint7) (full rover0store))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_soil_analysis rover0 waypoint7))
	(sometime-before (have_rock_analysis rover4 waypoint7) (full rover7store))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_rock_analysis rover7 waypoint14))
	(sometime-before (have_rock_analysis rover4 waypoint7) (full rover4store))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_rock_analysis rover4 waypoint22))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_rock_analysis rover4 waypoint10))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_rock_analysis rover3 waypoint22))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_rock_analysis rover2 waypoint22))
	...
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_image rover6 objective7 colour))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_image rover6 objective0 high_res))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_image rover4 objective3 colour))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_image rover2 objective2 high_res))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_image rover1 objective7 colour))
	(sometime-before (have_rock_analysis rover4 waypoint7) (have_image rover1 objective3 colour))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover7 waypoint2))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover7 waypoint15))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover6 waypoint8))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover6 waypoint13))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover3 waypoint23))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover3 waypoint22))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover3 waypoint21))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover3 waypoint13))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover2 waypoint18))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover2 waypoint23))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover2 waypoint13))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover1 waypoint18))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover1 waypoint1))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover0 waypoint12))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover0 waypoint21))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover0 waypoint11))
	(sometime-before (have_rock_analysis rover3 waypoint12) (at rover0 waypoint8))
	(sometime-before (have_rock_analysis rover3 waypoint12) (full rover6store))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_soil_analysis rover6 waypoint20))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_soil_analysis rover6 waypoint11))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_soil_analysis rover3 waypoint23))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_soil_analysis rover0 waypoint7))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover7 waypoint16))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover7 waypoint14))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover7 waypoint10))
	(sometime-before (have_rock_analysis rover3 waypoint12) (full rover4store))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover4 waypoint22))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover3 waypoint22))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover3 waypoint21))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover3 waypoint18))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover3 waypoint9))
	(sometime-before (have_rock_analysis rover3 waypoint12) (full rover2store))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover2 waypoint18))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_rock_analysis rover2 waypoint9))
	(sometime-before (have_rock_analysis rover3 waypoint12) (calibrated camera6 rover6))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_image rover6 objective0 high_res))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_image rover6 objective5 high_res))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_image rover5 objective0 high_res))
	...
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_image rover1 objective0 high_res))
	(sometime-before (have_rock_analysis rover3 waypoint12) (have_image rover1 objective5 high_res))
        ))
)
