...
(define (problem roverprob1425)
	...
	(sometime (have_image rover2 objective0 colour))
	...
	(sometime (have_image rover0 objective0 colour))
	(at-most-once (at rover1 waypoint4))
	(at-most-once (at rover1 waypoint8))
	(at-most-once (at rover1 waypoint6))
	(at-most-once (at rover1 waypoint5))
	...
	(at-most-once (calibrated camera4 rover0))
	(sometime-before (at rover1 waypoint8) (have_soil_analysis rover0 waypoint6))
	(sometime-before (at rover1 waypoint8) (have_image rover0 objective0 low_res))
	(sometime-before (at rover1 waypoint8) (have_image rover0 objective0 colour))
	(sometime-before (at rover1 waypoint5) (calibrated camera1 rover2))
	(sometime-before (at rover1 waypoint5) (have_image rover1 objective2 low_res))
	(sometime-before (at rover0 waypoint3) (full rover0store))
	(sometime-before (at rover0 waypoint3) (calibrated camera4 rover0))
	(sometime-before (at rover0 waypoint3) (have_image rover0 objective0 low_res))
	(sometime-before (have_soil_analysis rover0 waypoint3) (at rover0 waypoint6))
	(sometime-before (have_soil_analysis rover0 waypoint3) (have_rock_analysis rover1 waypoint8))
	(sometime-before (have_soil_analysis rover0 waypoint3) (calibrated camera1 rover2))
	(sometime-before (have_soil_analysis rover0 waypoint3) (have_image rover3 objective2 low_res))
	(sometime-before (have_rock_analysis rover1 waypoint8) (at rover1 waypoint3))
	(sometime-before (have_rock_analysis rover1 waypoint8) (full rover1store))
	(sometime-before (have_rock_analysis rover1 waypoint8) (full rover0store))
	(sometime-before (have_rock_analysis rover1 waypoint8) (calibrated camera1 rover2))
	(sometime-before (have_rock_analysis rover1 waypoint8) (have_image rover1 objective2 low_res))
	(sometime-before (have_rock_analysis rover1 waypoint8) (have_image rover1 objective0 colour))
	(sometime-before (have_rock_analysis rover1 waypoint5) (have_soil_analysis rover0 waypoint3))
	(sometime-before (have_rock_analysis rover1 waypoint5) (have_image rover3 objective2 low_res))
	(sometime-before (have_rock_analysis rover1 waypoint5) (have_image rover1 objective0 low_res))
	(sometime-before (have_rock_analysis rover1 waypoint5) (have_image rover1 objective0 colour))
	(sometime-before (have_rock_analysis rover1 waypoint4) (at rover1 waypoint5))
	(sometime-before (have_rock_analysis rover1 waypoint4) (at rover0 waypoint3))
	(sometime-before (have_rock_analysis rover1 waypoint4) (full rover1store))
	(sometime-before (have_rock_analysis rover1 waypoint4) (full rover0store))
	(sometime-before (have_rock_analysis rover1 waypoint4) (have_image rover1 objective0 low_res))
        ))
)
