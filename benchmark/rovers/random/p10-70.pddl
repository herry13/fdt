...
(sometime-before (have_soil_analysis rover0 waypoint4) (have_rock_analysis rover3 waypoint0))
...
(sometime-before (have_rock_analysis rover3 waypoint1) (calibrated camera2 rover1))
...
(sometime-before (have_rock_analysis rover0 waypoint4) (at rover2 waypoint4))
...
(sometime-before (have_image rover1 objective3 low_res) (calibrated camera1 rover1))
(sometime (calibrated camera0 rover1))
(sometime-before (have_rock_analysis rover0 waypoint4) (at rover1 waypoint6))
(at-most-once (at rover2 waypoint3))
(sometime-before (have_image rover1 objective3 colour) (at rover3 waypoint0))
(sometime-before (have_image rover1 objective3 colour) (at rover3 waypoint5))
(sometime (have_soil_analysis rover1 waypoint6))
(sometime (have_image rover1 objective2 colour))
(at-most-once (empty rover0store))
(sometime-before (have_image rover1 objective3 colour) (full rover2store))
(sometime-before (have_image rover1 objective3 low_res) (have_rock_analysis rover0 waypoint4))
(always (at rover1 waypoint0))
(sometime (have_soil_analysis rover3 waypoint3))
(sometime-before (have_image rover1 objective3 low_res) (calibrated camera0 rover1))
(sometime-before (have_soil_analysis rover0 waypoint4) (have_rock_analysis rover3 waypoint1))
(sometime-before (have_rock_analysis rover2 waypoint3) (calibrated camera0 rover1))
(sometime (full rover2store))
(sometime (have_soil_analysis rover1 waypoint0))
(sometime-before (have_rock_analysis rover2 waypoint3) (at rover1 waypoint2))
(at-most-once (empty rover2store))
(sometime-before (have_image rover1 objective3 low_res) (at rover0 waypoint3))
(sometime-before (have_rock_analysis rover3 waypoint1) (at rover1 waypoint2))
(sometime-before (have_soil_analysis rover0 waypoint4) (full rover3store))
(sometime (at rover3 waypoint4))
(always (at rover0 waypoint4))
(sometime (have_soil_analysis rover3 waypoint0))
(sometime-before (have_rock_analysis rover3 waypoint1) (calibrated camera5 rover3))
(sometime (calibrated camera5 rover3))
(sometime-before (have_rock_analysis rover3 waypoint1) (full rover3store))
(sometime-before (have_image rover1 objective3 low_res) (have_soil_analysis rover1 waypoint0))
(sometime (calibrated camera1 rover1))
(sometime-before (have_soil_analysis rover0 waypoint4) (full rover0store))
(at-most-once (full rover1store))
(sometime (full rover3store))
(sometime-before (have_rock_analysis rover3 waypoint0) (have_image rover1 objective3 colour))
(sometime-before (have_rock_analysis rover3 waypoint0) (at rover0 waypoint3))
(at-most-once (at rover3 waypoint0))
(sometime-before (have_image rover1 objective3 low_res) (at rover3 waypoint0))
(at-most-once (at rover2 waypoint5))
(sometime-before (have_rock_analysis rover3 waypoint1) (at rover0 waypoint3))
(sometime (have_image rover3 objective2 colour))
(sometime-before (have_rock_analysis rover3 waypoint1) (have_soil_analysis rover3 waypoint0))
(sometime (calibrated camera3 rover1))
(sometime (at rover3 waypoint3))
(sometime (calibrated camera2 rover1))
(sometime-before (have_rock_analysis rover0 waypoint4) (calibrated camera3 rover1))
(at-most-once (at rover3 waypoint1))
(sometime-before (have_rock_analysis rover3 waypoint0) (have_image rover1 objective2 colour))
(sometime-before (have_soil_analysis rover0 waypoint4) (calibrated camera0 rover1))
(sometime-before (have_rock_analysis rover3 waypoint0) (have_soil_analysis rover0 waypoint4))
(sometime (at rover3 waypoint5))
(sometime (at rover1 waypoint2))
(sometime (at rover1 waypoint6))
(sometime-before (have_rock_analysis rover2 waypoint3) (have_soil_analysis rover1 waypoint0))
(sometime-before (have_rock_analysis rover2 waypoint3) (at rover3 waypoint0))
(sometime (at rover3 waypoint6))
(sometime-before (have_rock_analysis rover3 waypoint1) (calibrated camera1 rover1))
(sometime-before (have_rock_analysis rover2 waypoint3) (full rover1store))
(sometime-before (have_image rover1 objective3 low_res) (at rover3 waypoint5))
(at-most-once (empty rover1store))
(sometime-before (have_rock_analysis rover0 waypoint4) (have_rock_analysis rover2 waypoint3))
))
)
