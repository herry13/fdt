...
(:constraints (and
(sometime-before (have_soil_analysis rover0 waypoint0) (calibrated camera0 rover0))
(sometime-before (have_image rover0 objective1 low_res) (have_rock_analysis rover0 waypoint0))
(sometime-before (have_image rover0 objective1 low_res) (have_soil_analysis rover0 waypoint0))
))
)
