...
(sometime-before (have_rock_analysis rover0 waypoint12) (have_soil_analysis rover3 waypoint14))
...
(sometime-before (at rover3 waypoint5) (have_rock_analysis rover4 waypoint9))
...
(sometime-before (have_soil_analysis rover3 waypoint2) (calibrated camera3 rover3))
(sometime (at rover3 waypoint6))
(at-most-once (empty rover4store))
(always (at rover2 waypoint5))
(sometime-before (at rover3 waypoint3) (have_rock_analysis rover0 waypoint12))
...
(at-most-once (calibrated camera4 rover5))
...
(sometime-before (have_rock_analysis rover0 waypoint12) (full rover3store))
...
(sometime-before (have_soil_analysis rover3 waypoint14) (calibrated camera5 rover1))
...
(at-most-once (calibrated camera6 rover2))
...
(sometime-before (at rover3 waypoint3) (calibrated camera5 rover1))
...
(sometime-before (at rover3 waypoint5) (have_rock_analysis rover4 waypoint5))
...
(sometime-before (at rover3 waypoint14) (have_image rover2 objective5 colour))
...
(at-most-once (at rover5 waypoint8))
...
(sometime (have_rock_analysis rover4 waypoint9))
(sometime (have_image rover5 objective5 colour))
))
)
