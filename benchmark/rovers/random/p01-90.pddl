...
(sometime-before (have_soil_analysis rover0 waypoint2) (have_soil_analysis rover0 waypoint0))
(sometime-before (have_image rover0 objective1 high_res) (have_rock_analysis rover0 waypoint3))
(sometime-before (have_rock_analysis rover0 waypoint3) (have_rock_analysis rover0 waypoint1))
(sometime-before (have_image rover0 objective1 high_res) (full rover0store))
(sometime-before (have_rock_analysis rover0 waypoint3) (full rover0store))
...
(sometime-before (have_rock_analysis rover0 waypoint3) (at rover0 waypoint0))
(sometime-before (have_rock_analysis rover0 waypoint3) (have_image rover0 objective1 high_res))
(sometime-before (have_rock_analysis rover0 waypoint3) (at rover0 waypoint2))
(sometime-before (at rover0 waypoint2) (have_soil_analysis rover0 waypoint0))
(at-most-once (empty rover0store))
(at-most-once (at rover0 waypoint3))
