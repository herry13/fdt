...
(sometime-before (have_image rover0 objective0 high_res) (have_image rover2 objective4 high_res))
(sometime (have_soil_analysis rover1 waypoint9))
(sometime (at rover3 waypoint7))
(sometime-before (have_image rover0 objective0 high_res) (at rover0 waypoint7))
...
(sometime-before (have_image rover0 objective0 high_res) (at rover2 waypoint5))
...
(sometime-before (have_image rover0 objective0 high_res) (at rover3 waypoint3))
