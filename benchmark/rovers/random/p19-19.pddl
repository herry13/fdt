...
(:constraints (and
(at-most-once (full rover4store))
(always (at rover0 waypoint2))
(sometime (have_image rover1 objective6 low_res))
(sometime (have_soil_analysis rover3 waypoint8))
(sometime (have_image rover4 objective5 colour))
(sometime (at rover4 waypoint15))
(sometime (at rover4 waypoint13))
(sometime (have_image rover4 objective2 low_res))
(sometime (at rover4 waypoint19))
(at-most-once (at rover3 waypoint11))
(sometime (calibrated camera3 rover0))
(at-most-once (at rover4 waypoint2))
(sometime (at rover5 waypoint3))
(sometime (at rover4 waypoint5))
(sometime (at rover3 waypoint1))
(sometime (at rover2 waypoint18))
(sometime (have_image rover4 objective0 colour))
...
(sometime (have_image rover3 objective7 colour))
(sometime (have_image rover2 objective0 high_res))
(sometime (have_image rover5 objective0 high_res))
(sometime (at rover0 waypoint0))
(at-most-once (empty rover5store))
(sometime (calibrated camera2 rover1))
(sometime (at rover3 waypoint19))
(at-most-once (at rover5 waypoint12))
(sometime (calibrated camera4 rover4))
(sometime (at rover1 waypoint15))
(sometime (at rover4 waypoint3))
(sometime (at rover3 waypoint13))
(sometime (calibrated camera6 rover5))
(sometime (at rover4 waypoint17))
(sometime (have_image rover3 objective0 colour))
(sometime (have_image rover2 objective7 low_res))
(sometime (have_rock_analysis rover4 waypoint19))
(sometime (at rover5 waypoint9))
...
(sometime (have_image rover5 objective0 colour))
(sometime (have_image rover5 objective4 high_res))
(sometime (have_image rover3 objective6 low_res))
(always (at rover2 waypoint13))
(sometime (have_rock_analysis rover3 waypoint19))
(sometime (have_rock_analysis rover5 waypoint4))
(sometime (have_rock_analysis rover4 waypoint6))
(sometime (have_image rover5 objective7 colour))
...
(at-most-once (at rover5 waypoint4))
(sometime (have_rock_analysis rover3 waypoint4))
(sometime (have_soil_analysis rover5 waypoint5))
...
(sometime (have_soil_analysis rover4 waypoint5))
))
)
