...
(sometime-before (have_rock_analysis rover1 waypoint6) (at rover3 waypoint3))
(always (at rover0 waypoint4))
(sometime-before (at rover2 waypoint0) (have_rock_analysis rover1 waypoint6))
...
(sometime-before (have_soil_analysis rover2 waypoint0) (at rover3 waypoint1))
...
(sometime-before (have_soil_analysis rover2 waypoint0) (calibrated camera2 rover0))
(sometime-before (at rover1 waypoint6) (calibrated camera0 rover3))
...
(sometime-before (have_rock_analysis rover1 waypoint6) (full rover3store))
(at-most-once (at rover2 waypoint7))
(sometime-before (have_soil_analysis rover2 waypoint0) (calibrated camera0 rover3))
(sometime-before (have_rock_analysis rover1 waypoint6) (have_image rover3 objective2 low_res))
...
(sometime-before (at rover1 waypoint6) (calibrated camera3 rover3))
...
(sometime-before (have_soil_analysis rover2 waypoint0) (at rover0 waypoint7))
(sometime-before (at rover1 waypoint6) (at rover0 waypoint2))
(sometime-before (have_rock_analysis rover1 waypoint6) (at rover3 waypoint5))
(at-most-once (empty rover2store))
(at-most-once (empty rover1store))
(sometime-before (at rover2 waypoint0) (have_image rover0 objective2 low_res))
