...
(sometime-before (have_rock_analysis rover0 waypoint2) (full rover3store))
(at-most-once (at rover5 waypoint0))
(at-most-once (at rover0 waypoint2))
(at-most-once (at rover4 waypoint6))
...
(sometime-before (have_soil_analysis rover2 waypoint0) (have_image rover5 objective4 high_res))
...
(sometime (have_image rover4 objective2 colour))
...
(sometime-before (have_rock_analysis rover0 waypoint2) (calibrated camera0 rover1))
