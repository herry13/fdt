...
(sometime-before (have_image rover0 objective0 high_res) (have_rock_analysis rover2 waypoint4))
(sometime-before (have_image rover0 objective0 high_res) (at rover0 waypoint1))
(at-most-once (full rover1store))
(sometime-before (have_soil_analysis rover0 waypoint1) (at rover1 waypoint4))
(sometime-before (have_image rover0 objective0 high_res) (full rover0store))
(sometime (at rover1 waypoint4))
(sometime-before (have_soil_analysis rover0 waypoint1) (full rover2store))
(always (at rover2 waypoint4))
(sometime-before (have_rock_analysis rover1 waypoint3) (full rover2store))
(sometime (full rover0store))
(sometime-before (have_soil_analysis rover2 waypoint4) (at rover0 waypoint1))
(sometime (have_rock_analysis rover2 waypoint4))
(sometime-before (have_rock_analysis rover1 waypoint3) (full rover0store))
(sometime-before (have_image rover0 objective0 high_res) (have_soil_analysis rover2 waypoint4))
(at-most-once (empty rover2store))
(at-most-once (full rover2store))
(sometime-before (have_image rover0 objective0 high_res) (at rover1 waypoint0))
...
(sometime-before (have_soil_analysis rover0 waypoint1) (calibrated camera0 rover0))
))
)
