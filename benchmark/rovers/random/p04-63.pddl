...
(sometime-before (have_soil_analysis rover0 waypoint3) (full rover1store))
(sometime-before (have_rock_analysis rover1 waypoint1) (at rover0 waypoint1))
(sometime (full rover1store))
(sometime-before (at rover1 waypoint1) (calibrated camera0 rover1))
(sometime-before (at rover1 waypoint1) (full rover0store))
(sometime-before (have_image rover1 objective0 high_res) (full rover1store))
(sometime-before (have_image rover1 objective0 high_res) (have_soil_analysis rover0 waypoint3))
(at-most-once (at rover1 waypoint2))
(sometime (at rover0 waypoint1))
(always (at rover0 waypoint3))
(sometime (at rover1 waypoint3))
(sometime-before (have_rock_analysis rover1 waypoint1) (full rover0store))
(sometime-before (have_soil_analysis rover0 waypoint3) (at rover1 waypoint1))
(at-most-once (empty rover1store))
(sometime-before (have_image rover1 objective0 high_res) (full rover0store))
