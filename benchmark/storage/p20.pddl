...
;;--- start of goal preferences ---;;
	...
	(clear depotA-1-2)
	(clear depotA-2-1)
	(forall (?c - crate)  p9A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot1)))))
	(forall (?c - crate)  p14A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot2)))))
	(forall (?c - crate)  p18A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot3)))))
	(forall (?c - crate)  p22A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot4)))))
	(forall (?c - crate)  p28A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot5)))))
	(forall (?c - crate)  p32A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot6)))))
	(forall (?c - crate)  p37A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot7)))))
	(forall (?c - crate)  p42A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot8)))))
	(forall (?c - crate)  p47A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depot9)))))
	(forall (?c - crate)  p51A (exists (?d - depot) (and (in ?c ?d) (not (= ?d depotA)))))
...
(:constraints (and
	...
	(sometime-before (exists (?d1 - depot) (in crate0 ?d1)) (exists (?d2 - depot) (in crate19 ?d2)))
	...
	(sometime-before (exists (?d1 - depot) (in crate1 ?d1)) (exists (?d2 - depot) (in crate19 ?d2)))
))
)
