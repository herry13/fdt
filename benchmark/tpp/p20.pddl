...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods6 ?l)) (stored goods15 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods16 ?l)) (stored goods20 ?l)))
))
)
