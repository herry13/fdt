...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods2 ?l)) (stored goods10 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods2 ?l)) (stored goods11 ?l)))
))
)
