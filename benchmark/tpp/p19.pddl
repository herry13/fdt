...
;;--- start of goal preferences ---;;
	...
	(forall (?g - goods) (exists (?l - level) (and (not (= ?l level0)) (not (= ?l level3)) (stored ?g ?l))))
	(forall (?g - goods) (exists (?l - level) (and (not (= ?l level0)) (not (= ?l level4)) (stored ?g ?l))))
	(forall (?g - goods) (exists (?l - level) (and (not (= ?l level0)) (not (= ?l level5)) (stored ?g ?l))))
	(forall (?g - goods) (exists (?l - level) (and (not (= ?l level0)) (not (= ?l level6)) (stored ?g ?l))))
...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods2 ?l)) (stored goods12 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods16 ?l)) (stored goods18 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods2 ?l)) (stored goods13 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods12 ?l)) (stored goods19 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods7 ?l)) (stored goods10 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods9 ?l)) (stored goods19 ?l)))
))
)
