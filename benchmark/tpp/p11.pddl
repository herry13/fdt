...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods1 ?l)) (stored goods8 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods10 ?l)) (stored goods11 ?l)))
))
)
