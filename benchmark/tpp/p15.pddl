...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods8 ?l)) (stored goods13 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods5 ?l)) (stored goods12 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods1 ?l)) (stored goods7 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods14 ?l)) (stored goods15 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods5 ?l)) (stored goods9 ?l)))
))
)
