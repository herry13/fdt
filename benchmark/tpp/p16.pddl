...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods15 ?l)) (stored goods16 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods6 ?l)) (stored goods10 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods13 ?l)) (stored goods16 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods11 ?l)) (stored goods12 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods6 ?l)) (stored goods9 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods11 ?l)) (stored goods15 ?l)))
))
)
