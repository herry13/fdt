...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods5 ?l)) (stored goods7 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods3 ?l)) (stored goods7 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods4 ?l)) (stored goods8 ?l)))
))
)
