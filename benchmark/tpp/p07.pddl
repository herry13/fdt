...
(:constraints (and
	...
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods6 ?l)) (stored goods7 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods4 ?l)) (stored goods5 ?l)))
	(forall (?l - level) (sometime-before (and (not (= ?l level0)) (stored goods3 ?l)) (stored goods6 ?l)))
))
)
